...
!(function (n, t, e) {
  ...
  function P(n, t) {
    return R(n) ? new E.LatLngBounds({ lat: n[2], lng: n[3] }, { lat: n[0], lng: n[1] }) : t && !n.getCenter ? new E.LatLngBounds({ lat: n.south, lng: n.west }, { lat: n.north, lng: n.east }) : n;
  }
  function b(t, o) {
    function r() {
      function n(n) {
        ...
        s(function () {
          (t.google && t.google.maps) || j === !1
            ...
            : ((t[i] = function () {
              ...
              (o.src = 'https://maps.googleapis.com/maps/api/js?callback=' + i + (j ? '&' + ('string' == typeof j ? j : f(j)) : '')),
              n('head').append(o));
        }),
        r
      );
